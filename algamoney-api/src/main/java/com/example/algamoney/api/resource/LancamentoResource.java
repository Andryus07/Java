...
public class LancamentoResource {
	...
	public ResponseEntity<Lancamento> buscarPeloCodigo(@PathVariable Long codigo) {
		Lancamento lacamento = lancamentoRepository.findOne(codigo);
		return lacamento != null ? ResponseEntity.ok(lacamento) : ResponseEntity.notFound().build();
	}
	...
	public ResponseEntity<Object> handlerPessoaInexistenteOuInativaException(PessoaInexistenteOuInativaException ex) {
		...
		List<Erro> erros = Arrays.asList(AlgamoneyExceptionHandler.new Erro(mensagemUsuario, mensagemDesenvolvedor));
